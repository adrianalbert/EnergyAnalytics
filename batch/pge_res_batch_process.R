...
cfg = list()
#cfg$outDir = 'w_results_occ_segments'
cfg$outDir = 'results_daily_full_2'
...
cfg$CALC_SOLAR_GEOM     = T  # calculate sun position for every hour - this takes a long time for some reason
