...
cfg = list()
cfg$outDir = 'results_climate_test'
...
cfg$models.hourly = list(
  ...
  #wea65        = list(formula="kw ~ tout65 + pout + rh + HOW + MOY",subset=list(all="TRUE",summer=cfg$subset$summer)),
  #HOW         = "kw ~ tout + HOW",
  #toutTOD_WKND = list(formula="kw ~ 0 + tout65:HODWK + HODWK",subset=list(summer=cfg$subset$summer))
  ...
  #toutTOD_l3   = list(formula="kw ~ 0 + tout65:HOD + pout + rh + tout65_l3 + HOD",subset=list(summer=cfg$subset$summer))
